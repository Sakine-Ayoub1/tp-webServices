 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://services.ayoub.sakine/", wsdlLocation = "http://localhost:9000/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://services.ayoub.sakine/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://services.ayoub.sakine/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ayoub.sakine/", "BanqueWSPort"), BanqueWS.class, features);
    }
